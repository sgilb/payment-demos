...
function payWithCheckout(googleToken) {
    ...
    http({
            ...
            route: '/payWithGoogle',
            body: {
                signature: JSON.parse(googleToken).signature,
                protocolVersion: JSON.parse(googleToken)
                    .protocolVersion,
                signedMessage: JSON.parse(googleToken)
                    .signedMessage
            }
        },
...
// Utility function for simpler API calls
const http = ({
    method,
    route,
    body
